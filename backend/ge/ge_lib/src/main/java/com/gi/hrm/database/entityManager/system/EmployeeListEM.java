package com.gi.hrm.database.entityManager.system;

import com.gi.hrm.common.CommonEntityManager;
...
public class EmployeeListEM extends CommonEntityManager {
	...
	private static final String QUERY_SELECT = "SELECT dtb.employeeId AS id, dtb.imageUrl, dtb.employeeName, "
	        ...
	        + "TO_CHAR(dtb.dateOfBirth," + CommonEntityManager.DATE_SQLFORMAT + ") AS dateOfBirth\n";
