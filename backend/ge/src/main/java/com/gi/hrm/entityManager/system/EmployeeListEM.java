...
public class EmployeeListEM extends CommonEntityManager {
	...
	public ResultPageResponse searchListEmployee(EmployeeListSearchRequest request) {
		...
		List<String> listFields = List.of(COND_NAME, COND_EMAIL, COND_DEPARTMENT, COND_CODE, COND_DATE_OF_BIRTH,
		        COND_KEYS);
		...
		setQueryParameters(List.of(listQuery, countQuery), request);
